import { AlertTriangle, Users, Heart, Shield, Navigation, Clock, MapPin, TrendingUp } from 'lucide-react';
  ...
  const myAlerts = [
    {
      ...
      description: 'Difficult to move through the area, recommend alternative routes',
            ...
            <div className="space-y-3">
              {myAlerts.map((alert) => {
                ...
                return (
                  <div
                    key={alert.id}
                    className={`rounded-xl p-5 border ${getColorClasses(alert.color)}`}
                  >
